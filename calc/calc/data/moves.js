...
var PK = (0, util_1.extend)(true, {}, DPP, moves_1.PK_PATCH);
...
delete PK['Submission'].recoil;
delete PK['Superpower'].self;
delete PK['Overheat'].self;
delete PK['Psycho Boost'].self;
delete PK['Draco Meteor'].self;
delete PK['Leaf Storm'].self;
var BW_PATCH = {
...
exports.MOVES = [{}, RBY, GSC, ADV, PK, BW, XY, SM, SS, SV];
var Moves = (function () {
    function Moves(gen) {
        this.gen = gen;
    }
