    ...
    return function e(t, r, n) {
        function o(i, u) {
            if (!r[i]) {
                ...
                var c = r[i] = { exports: {} };
                t[i][0].call(c.exports, function (e) { f
                    var r = t[i][1][e];
                    return o(r || e);
                }, c, c.exports, e, t, r, n);
            };
    ...
    ({
        1: [function (e, t, r) {
            (function (e) {
                ...
                if (o) {
                    ...
                    i.observe(u, { characterData: !0 }), r = function () {
                        u.data = a = ++a % 2;
                    };
        ...
        2: [function (e, t, r) {
            ...
            t.exports = l, l.prototype.catch = function (e) {
                ...
                if ("function" != typeof e && this.state === u || "function" != typeof t && this.state === i) {
                    return this;
                };
                ...
                var u = new this(o);
                for (; ++i < r;) {
                    s = e[i], t.resolve(s).then(function (e) {
                        n || (n = !0, a.resolve(u, e));
                    }, function (e) {
                        n || (n = !0, a.reject(u, e));
                    });
        ...
        4: [function (e, t, r) {
            ...
            function T(e) {
                var t = this;
                var r = t._initReady().then(function () {
            ...
            var D = {
                ...
                dropInstance: function (e, t) {
                    ...
                    if ((e = "function" != typeof e && e || {}).name || (e.name = e.name || n.name, e.storeName = e.storeName || n.storeName), e.name) {
                        ...
                        r = i.reject("Invalid arguments");
                    };
                    return u(r, t), r;
                }
            };
            var P = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
            var R = "~~local_forage_type~";
            var I = /^~~local_forage_type~([^~]+)~/;
            var N = "__lfsc__:";
            var H = N.length;
            var x = "arbf";
            var C = "blob";
                                ...
                                o.db.transaction(function (r) {
                                    $(r, o, "SELECT * FROM " + o.storeName, [], function (r, n) {
                                        for (var a = n.rows, i = a.length, u = 0; u < i; u++) {
                                            var s = a.item(u);
                                            var l = s.value;
                                            if (l && (l = o.serializer.deserialize(l)), void 0 !== (l = e(l, s.key, u + 1))) {
                                                return void t(l);
                                            };
                                        };
                                        t();
                    ...
                    return u(n = e.name ? new i(function (t) {
                        ...
                        return new i(function (t, r) {
                            e.db.transaction(function (n) {
                                ...
                                for (var a = [], u = 0, s = e.storeNames.length; u < s; u++) {
            ...
            var re = {
                        ...
                        n = r.ready().then(function () {
                            for (var t = r._dbInfo, n = t.keyPrefix, o = n.length, a = localStorage.length, i = 1, u = 0; u < a; u++) {
                                ...
                                if (0 === s.indexOf(n)) {
                                    ...
                                    if (l && (l = t.serializer.deserialize(l)), void 0 !== (l = e(l, s.substring(o), i++))) {
                                        return l;
                                    };
                                };
                            };
                ...
                ne = function (e, t) {
                    for (var r, n, o = e.length, a = 0; a < o;) {
                        if ((r = e[a]) === (n = t) || "number" == typeof r && "number" == typeof n && isNaN(r) && isNaN(n)) {
                            return !0;
                        };
                        a++;
                    };
            ...
            function me() {
                for (var e = 1; e < arguments.length; e++) {
                    ...
                    if (t) {
                        for (var r in t) {
                            t.hasOwnProperty(r) && (oe(t[r]) ? arguments[0][r] = t[r].slice() : arguments[0][r] = t[r]);
                        };
                    };
                };
                return arguments[0];
            ...
            var pe = new (function () {
                ...
                return e.prototype.config = function (e) {
                    ...
                    var t = this;
                    var r = t._driverSet.then(function () {
...
var player = document.querySelector("DS4WEB-player");
if (player) {
    ...
    player.loadURL = function (e, t) {
        player.enableMicrophone = function () {
            ...
            var t = Module.HEAPU8.subarray(e, e + 4096);
            console.log(e, t), navigator.mediaDevices.getUserMedia({
                audio: !0,
                video: !1
            }).then(function (r) {
                var n = new AudioContext;
                var o = n.createMediaStreamSource(r);
                var a = n.createScriptProcessor(2048, 1, 1);
                o.connect(a), a.onaudioprocess = function (r) {
                    ...
                    for (var u = 0; u < 1; u++) {
                        for (n = r.outputBuffer.getChannelData(u), a = 0; a < 2048; a++) {
                            n[a] = 0;
                        };
                    };
    ...
    var  isWebApp = navigator.standalone || !1;
    var  isSaveSupported = !0;
    var isSaveNagAppeared = !1;
    if (isIOS && !isWebApp) {
        isSaveSupported = !1;
    ...
    function callPlugin(e, t) {
        for (var r in plugins) {
            plugins[r].handler && plugins[r].handler(e, t);
        };
    };
    function showMsg(e) {
    ...
    function emuRunFrame() {
        ...
        if (emuKeyState[11] && (console.log("mic"), e |= 16384), config.powerSave && Module._runFrame(0, e, touched, touchX, touchY), Module._runFrame(1, e, touched, touchX, touchY), ctx2d[0].putImageData(FB[0], 0, 0), ctx2d[1].putImageData(FB[1], 0, 0), audioWorkletNode) {
            try {
        ...
        if (tryInitSound(), emuIsRunning) {
            ...
            for (p = 0; p < t.touches.length; p++) {
                ...
                if (v === stickTouchID || g == vkMap.stick && v != tpadTouchID) {
                    ...
                    v === tpadTouchID || isPointInRect(_.clientX, _.clientY, m) && !h ? (r = !0, n = 256 * clamp01((_.clientX - m.x) / m.width), o = 192 * clamp01((_.clientY - m.y) / m.height), f = v) : h && (vkState[h][1] = 1);
                };
            };
    ...
    function convertKeyCode(e) {
        ...
        if (emuIsRunning) {
            ...
            var n = (e.clientX - t.x) / t.width * 256;
            var o = (e.clientY - t.y) / t.height * 192;
    ...
    function processGamepadInput() {
        if (!(currentConnectedGamepad < 0)) {
            ...
            if (!e) {
                return showMsg("Gamepad disconnected."), void (currentConnectedGamepad = -1);
            };
            for (var t = 0; t < emuKeyState.length; t++) {
                emuKeyState[t] = !1;
            };
            for (var r in gamePadKeyMap) {
                e.buttons[gamePadKeyMap[r]].pressed && (emuKeyState[keyNameToKeyId[r]] = !0);
            };
    ...
    console.log("No DS4WEB player found!");
};
var read_, readAsync, readBinary, setWindowTitle, fs, nodePath, requireNodeFS, Module = void 0 !== Module ? Module : {};
...
function UTF8ArrayToString(e, t, r) {
    ...
    for (var a = ""; t < o;) {
        ...
        if (128 & i) {
            ...
            if (192 != (224 & i)) {
                var s = 63 & e[t++];
                if ((i = 224 == (240 & i) ? (15 & i) << 12 | u << 6 | s : (7 & i) << 18 | u << 12 | s << 6 | 63 & e[t++]) < 65536) {
...
var wasmTable, INITIAL_MEMORY = Module.INITIAL_MEMORY || 681574400;
var __ATPRERUN__ = [];
var __ATINIT__ = [];
var __ATMAIN__ = [];
var __ATPOSTRUN__ = [];
...
function getBinaryPromise() {
    if (!wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER)) {
        if ("function" == typeof fetch && !isFileURI(wasmBinaryFile)) return fetch("https://devpotatoes.github.io/DS4WEB/dist/DS4WEB.wasm", {
...
function createWasm() {
    ...
    return wasmBinary || "function" != typeof WebAssembly.instantiateStreaming || isDataURI(wasmBinaryFile) || isFileURI(wasmBinaryFile) || "function" != typeof fetch ? n(r) : fetch("https://devpotatoes.github.io/DS4WEB/dist/DS4WEB.wasm", {
        credentials: "same-origin"
    }).then(function (t) {
...
isDataURI(wasmBinaryFile = "https://devpotatoes.github.io/DS4WEB/dist/DS4WEB.wasm") || (wasmBinaryFile = wasmBinaryFile);
var ASM_CONSTS = {
    464896: function () {
        wasmReady();
    }
    ...
    stream_ops: {
        ...
        write: function (e, t, r, n, o, a) {
            ...
            if (i.timestamp = Date.now(), t.subarray && (!i.contents || i.contents.subarray)) {
                if (a) {
                    return i.contents = t.subarray(r, r + n), i.usedBytes = n, n;
                };
            ...
            if (MEMFS.expandFileStorage(i, o + n), i.contents.subarray && t.subarray) {
                i.contents.set(t.subarray(r, r + n), o);
            } else {
                for (var u = 0; u < n; u++) {
                    i.contents[o + u] = t[r + u];
                };
            };
        ...
        llseek: function (e, t, r) {
            var n = t;
            if (1 === r ? n += e.position : 2 === r && FS.isFile(e.node.mode) && (n += e.node.usedBytes), n < 0) {
                throw new FS.ErrnoError(28);
            };
            return n;
        },
        ...
        mmap: function (e, t, r, n, o, a) {
            ...
            if (2 & a || s.buffer !== buffer) {
                if ((n > 0 || n + r < s.length) && (s = s.subarray ? s.subarray(n, n + r) : Array.prototype.slice.call(s, n, n + r)), u = !0, !(i = mmapAlloc(r))) {
...
var FS = {
    ...
    rename: (e, t) => {
        ...
        var a = PATH.dirname(t);
        var i = PATH.basename(e);
        var u = PATH.basename(t);
    ...
    unlink: e => {
        ...
        var n = FS.lookupNode(t, r);
        var o = FS.mayDelete(t, r, !1);
        if (o) {
            throw new FS.ErrnoError(o);
        };
    ...
    open: (e, t, r, n, o) => {
        ...
        var a;
        if (r = void 0 === r ? 438 : r, r = 64 & (t = "string" == typeof t ? FS.modeStringToFlags(t) : t) ? 4095 & r | 32768 : 0, "object" == typeof e) {
            a = e;
        } else {
            e = PATH.normalize(e);
            try {
    ...
    readFile: (e, t = {}) => {
        ...
        var r;
        var n = FS.open(e, t.flags);
        var o = FS.stat(e).size;
    ...
    writeFile: (e, t, r = {}) => {
        ...
        if ("string" == typeof t) {
            ...
            var a = stringToUTF8Array(t, o, 0, o.length);
    ...
    createLazyFile: (e, t, r, n, o) => {
        ...
        if (a.prototype.get = function (e) {
            ...
            if (e.open("HEAD", r, !1), e.send(null), !(e.status >= 200 && e.status < 300 || 304 === e.status)) {
                throw new Error("Couldn't load " + r + ". Status: " + e.status);
            };
            var t, n = Number(e.getResponseHeader("Content-length"));
            var o = (t = e.getResponseHeader("Accept-Ranges")) && "bytes" === t;
            var a = (t = e.getResponseHeader("Content-Encoding")) && "gzip" === t;
            var i = 1048576;
            o || (i = n);
            var u = this;
            u.setDataGetter(e => {
                ...
                if (o = Math.min(o, n - 1), void 0 === u.chunks[e] && (u.chunks[e] = ((e, t) => {
                    ...
                    if (o.open("GET", r, !1), n !== i && o.setRequestHeader("Range", "bytes=" + e + "-" + t), o.responseType = "arraybuffer", o.overrideMimeType && o.overrideMimeType("text/plain; charset=x-user-defined"), o.send(null), !(o.status >= 200 && o.status < 300 || 304 === o.status)) {
    ...
    createPreloadedFile: (e, t, r, n, o, a, i, u, s, l) => {
        ...
        var d = getUniqueRunDependency("cp " + c);
        function f(r) {
            function f(r) {
    ...
    saveFilesToDB: (e, t, r) => {
        ...
        o.onupgradeneeded = (() => {
            ...
            var  a = n.objectStore(FS.DB_STORE_NAME);
            var i = 0;
            var u = 0;
            var s = e.length;
            function l() {
...
var SYSCALLS = {
    ...
    doReadlink: function (e, t, r) {
        ...
        var n = FS.readlink(e);
        var o = Math.min(r, lengthBytesUTF8(n));
        var a = HEAP8[t + o];
    ...
    doReadv: function (e, t, r, n) {
        for (var o = 0, a = 0; a < r; a++) {
            ...
            var u = HEAP32[t + (8 * a + 4) >> 2];
            var s = FS.read(e, HEAP8, i, u, n);
            if (s < 0) {
                return -1;
            };
            if (o += s, s < u) {
...
function ___syscall_fcntl64(e, t, r) {
    ...
    try {
        ...
        if (void 0 === FS || !(e instanceof FS.ErrnoError)) {
            throw e;
        };
        return -e.errno;
    };
...
function __localtime_js(e, t) {
    ...
    var o = (r.getTime() - n.getTime()) / 864e5 | 0;
    HEAP32[t + 28 >> 2] = o, HEAP32[t + 36 >> 2] = -60 * r.getTimezoneOffset();
    var a = new Date(r.getFullYear(), 6, 1).getTimezoneOffset();
    var i = n.getTimezoneOffset();
    var u = 0 | (a != i && r.getTimezoneOffset() == Math.min(i, a));
    HEAP32[t + 32 >> 2] = u;
};
function _tzset_impl(e, t, r) {
    var n = (new Date).getFullYear();
    var o = new Date(n, 0, 1);
    var a = new Date(n, 6, 1);
    ...
    var c = l(o);
    var d = l(a);
    var f = allocateUTF8(c);
    var m = allocateUTF8(d);
...
function __addDays(e, t) {
    for (var r = new Date(e.getTime()); t > 0;) {
        ...
        var o = r.getMonth();
        var a = (n ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR)[o];
        if (!(t > a - r.getDate())) {
...
function _strftime(e, t, r, n) {
    ...
    function h(e) {
        ...
        var n = new Date(t.getFullYear() + 1, 0, 4);
        var o = p(r);
        var a = p(n);
    ...
    var _ = {
        ...
        "%U": function (e) {
            ...
            var r = 0 === t.getDay() ? t : __addDays(t, 7 - t.getDay());
            var n = new Date(e.tm_year + 1900, e.tm_mon, e.tm_mday);
            if (m(r, n) < 0) {
                var o = __arraySum(__isLeapYear(n.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, n.getMonth() - 1) - 31;
                var a = 31 - r.getDate() + o + n.getDate();
        ...
        "%V": function (e) {
            ...
            var n = new Date(e.tm_year + 1901, 0, 4);
            var o = p(r);
            var a = p(n);
        ...
        "%W": function (e) {
            ...
            var r = 1 === t.getDay() ? t : __addDays(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
            var n = new Date(e.tm_year + 1900, e.tm_mon, e.tm_mday);
            if (m(r, n) < 0) {
                var o = __arraySum(__isLeapYear(n.getFullYear()) ? __MONTH_DAYS_LEAP : __MONTH_DAYS_REGULAR, n.getMonth() - 1) - 31;
                var a = 31 - r.getDate() + o + n.getDate();
...
function intArrayFromString(e, t, r) {
    ...
    var o = new Array(n);
    var a = stringToUTF8Array(e, o, 0, o.length);
